...
namespace Kata.Spec
{
    ...
    public class when_user_input_is_empty_return_zero
    {
    ...
    public class when_user_input_is_one_number_return_same
    {
        static Calculator _systemUnderTest;
        static int result;
    ...
    public class when_user_input_is_multiple_numbers_with_newline_delimiter_return_sum
    {
        static Calculator _systemUnderTest;
        static int result;
        ...
        Because of = () => 
            result = _systemUnderTest.Add("1\n2,3");

        It should_return_sum= () =>
            result.Should().Be(6);
    }
